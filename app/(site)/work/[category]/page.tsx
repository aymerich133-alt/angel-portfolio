  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        {/* ================= GRID (AUTO-OPEN) ================= */}
        <div className="mt-20 transition-all duration-500 mb-10">

          {/* CLOSE ACTION */}
          <div className="flex justify-center mb-6 ">
            <Link
              href="/#portfolio"
              className="inline-block text-sm text-[#1f2a44]/60 hover:text-[#1f2a44] transition"
            >
              ← Close
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10 max-w-5xl mx-auto">
            {projectsByCategory[activeCategory].map((project, index) => (
              <Link
                key={index}
                href={`/projects/${project.slug}?from=${activeCategory}`}
                className="
                  block rounded-xl p-6
                  border border-[#0B132B]/20
                  transition-all duration-300 ease-out
                  hover:bg-[#0B132B]/[0.02]
              ...
              >
                ...
                >
                  <img
                    src={`/images/projects/${project.slug}/thumb.png`}
                ...
                <h3 className="hero-title text-xl font-semibold text-[#0B132B] text-[#1E4E8C]">
                  {project.title}
                </h3>
                <p className="text-sm text-[#1f2a44]/70 mt-1 text-[#1E4E8C]">
                  {project.description}
                </p>
              </Link>
            ))}
